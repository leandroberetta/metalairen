...
export default function MazoMenu({
    ...
    return (
        <div className="flex flex-row overflow-x-scroll scrollbar-hide">
            <Tooltip content="Ver mazo" placement="top" arrow={false}>
                <Link
                    href={{
                        pathname: '/mazo/ver',
            ...
            <Tooltip content="Ver composisión del reino por costes" placement="top" arrow={false}>
            ...
            <Tooltip content="Descargar lista" placement="top" arrow={false}>
            ...
            <Tooltip content="Copiar lista al porta papeles" placement="top" arrow={false}>
            ...
            <Tooltip content="Importar lista desde el porta papeles" placement="top" arrow={false}>
            ...
            {session.data?.user && (
                <>
                    {pathName !== '/mazo/crear' && (
                        <>
                            <Tooltip content="Eliminar mazo" placement="top" arrow={false}>
                                    ...
                                    <div className="relative w-full max-w-md max-h-full">
                                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div className="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                <button onClick={() => onEliminarMazo()} type="button" className="text-gray-800 dark:bg-yellow-300 dark:hover:bg-yellow-400 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Eliminar</button>
                    ...
                    <Tooltip content="Guardar mazo" placement="top" arrow={false}>
