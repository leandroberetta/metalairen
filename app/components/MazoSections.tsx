...
import MazoChart from "./MazoChart";
...
export function MazoSections({ mazo, onPlusClick, onMinusClick, onSideboardClick, onImportClick }: {
    ...
    return (
        <div className="grid gap-4 sticky top-4 max-h-screen overflow-auto scrollbar-hide">
            <div className="flex">
                ...
                <button onClick={() => {setMostrarChart(!mostrarChart)}} type="button" className={clsx("focus:outline-none dark:bg-yellow-300 dark:hover:bg-yellow-400 font-medium rounded-lg text-sm px-2.5 py-2.5 me-2", {"dark:bg-yellow-400": mostrarChart} )}>
