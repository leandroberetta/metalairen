...
export default function MazoCartaRow({ carta, section, onPlusClick, onMinusClick, onSideboardClick }: {
    carta: CartaCantidad,
    section: string,
    ...
    return (
        <div className="flex gap-1">
            ...
            <button className="flex-grow item-mazo rounded text-white shadow-xl dark:shadow-xl dark:shadow-gray-800"
